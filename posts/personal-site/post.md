# Overview
It's the turn of the New Year, and I figured that it would be time to redo my portfolio website. Funny enough, it was around 11 months ago that I finished my [V2](https://kakumuo.github.io/portfolio/v2/index.html) set of changes. And some time before that, I did my changes for [V1](https://kakumuo.github.io/portfolio/v1/index.html). I was never really happy with where I landed with either of these sites. The first was created as an ability to showcase my skills with JavaScript and HTML. I tried to force myself to understand what each of the most important elements was doing, as well as being able to style them with CSS and JS. I even implemented some mouse hijacking. In the next revision, I wanted to lean more towards React, but still trying to do things from *scratch*. With this revision, I looked to create something that involved working with external APIs and different services. Styling was done in [TailwindCSS](https://tailwindcss.com/), and most of the components were from [MantineUI](https://mantine.dev/). I also limited my usage of any assistive technologies to truly understand what I was doing.
